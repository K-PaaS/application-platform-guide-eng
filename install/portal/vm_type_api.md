...
BOSH_ENVIRONMENT="${BOSH_ENVIRONMENT}"		# bosh director alias name (hen not using create-bosh-login.sh provided by PaaS-TA, check the name at bosh envs and enter)
