...
-	Access the service through the dashboard URL. (The administrator account of the service is serviceadmin/[Password is what the user has entered when applying for the service])  
